...
var relative = $nodePath.relative;
...
var ReadStream = $nodeFs.ReadStream;
var Stream$1 = $nodeStream;
var Zlib = $zlib;
...
const require$$4 = { uChars: uChars, gbChars: gbChars };
...
function requireStreams() {
  ...
  var Buffer = $nodeBuffer.Buffer,
    Transform = $nodeStream.Transform;
...
function requireExtendNode() {
  ...
  extendNode = function (iconv) {
    ...
    iconv.extendNodeEncodings = function extendNodeEncodings() {
      ...
      // -- SlowBuffer -----------------------------------------------------------
      var SlowBuffer = $nodeBuffer.SlowBuffer;
...
var basename = $nodePath.basename;
...
})(express$3, express$3.exports);

var express = express$3.exports;
